...
# Thêm khoa mới
@ql_router.post("/khoa/them", response_model=schemas.KhoaResponse)
async def them_khoa(
...
# Cập nhật khoa
@ql_router.put("/khoa/cap-nhat/{ma_khoa}", response_model=schemas.KhoaResponse)
...
# Xóa khoa
@ql_router.delete("/khoa/xoa/{ma_khoa}", response_model=dict)
async def xoa_khoa(
    ma_khoa: str,
    current_user: dict = Depends(get_current_user),
    db: AsyncSession = Depends(get_db)
...
@ql_router.get("/hnc/{ma_hnc}", response_model=schemas.HuongNghienCuuResponse)
...
@ql_router.post("/hnc/create", response_model=schemas.HuongNghienCuuResponse, status_code=201)
...
@ql_router.get("/sinh-vien/{ma_sv}", response_model=schemas.SinhVienResponse)
...
@ql_router.get("/sinh-vien", response_model=List[schemas.SinhVienResponse])
...
@ql_router.post("/sinh-vien/them", response_model=schemas.SinhVienResponse)
...
@ql_router.delete("/sinh-vien/xoa/{ma_sv}", response_model=dict)
...
@ql_router.post("/sinh-vien/dang-ky", response_model=dict)
...
@ql_router.put("/sinh-vien/cap-nhat/{ma_sv}", response_model=schemas.SinhVienResponse)
...
# Thêm giảng viên
@ql_router.post("/giang-vien/them", response_model=schemas.GiangVienResponse)
...
# Xóa giảng viên
@ql_router.delete("/giang-vien/xoa/{ma_gv}", response_model=dict)
...
# Cập nhật giảng viên
@ql_router.put("/giang-vien/cap-nhat/{ma_gv}", response_model=schemas.GiangVienResponse)
...
@ql_router.get("/giang-vien/{ma_gv}", response_model=schemas.GiangVienResponse)
...
@ql_router.get("/giang-vien", response_model=list[schemas.GiangVienResponse])
