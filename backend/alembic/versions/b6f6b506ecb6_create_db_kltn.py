...
Revision ID: b6f6b506ecb6
Revises: 
Create Date: 2025-03-07 14:53:06.741997
...
def upgrade() -> None:
    ...
    sa.Column('ma_de_tai', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('ten_de_tai', sa.String(length=255), nullable=False),
    sa.Column('thuong_cap_khoa', sa.Text(), nullable=True),
    sa.Column('thuong_cap_truong', sa.Text(), nullable=True),
    ...
    sa.Column('ngoai_ngu', sa.String(length=255), nullable=False),
