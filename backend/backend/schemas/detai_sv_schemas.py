...
class GiangVienInHNCResponse(BaseModel):
...
class HNCvaGV(HuongNghienCuuResponse):
    list_gv: List[GiangVienInHNCResponse] = Field(..., description="Danh sách giảng viên nghiên cứu theo hướng")
